        ...
        public static List<Product> GetBaseProducts()
        {
            return new List<Product>
            {
                new Product
                {
                    ...
                    Category = new Category { Name = "Electric Guitar" },
                    Brand = new Brand { Name = "Squier" },
                    Price = 9966.26,
                    Stock = 99,
                ...
                new Product
                {
                    ...
                    Category = new Category { Name = "Acoustic Guitar" },
                    Brand = new Brand { Name = "Ortega" },
                    Price = 16135.86,
                    Stock = 99,
                ...
                new Product
                {
                    ...
                    Category = new Category { Name = "Piano" },
                    Brand = new Brand { Name = "Roland" },
                    Price = 22839.36,
                    Stock = 99,
                ...
                new Product
                {
                    ...
                    Category = new Category { Name = "Piano" },
                    Brand = new Brand { Name = "Native Instruments" },
                    Price = 60865.4,
                    Stock = 99,
                ...
                new Product
                {
                    ...
                    Category = new Category { Name = "Clarinet" },
                    Brand = new Brand { Name = "Monzani" },
                    Price = 7474.7,
                    Stock = 99,
                ...
                new Product
                {
                    ...
                    Category = new Category { Name = "Trumpet" },
                    Brand = new Brand { Name = "Monzani" },
                    Price = 8601.84,
                    Stock = 99,
                ...
                new Product
                {
                    ...
                    Category = new Category { Name = "Drums" },
                    Brand = new Brand { Name = "Fame" },
                    Price = 20889.61,
                    Stock = 99,
                ...
                new Product
                {
                    ...
                    Category = new Category { Name = "Violin" },
                    Brand = new Brand { Name = "Monzani" },
                    Price = 6349.97,
                    Stock = 99,
